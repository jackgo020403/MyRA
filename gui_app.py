...
Simple chat-like interface similar to ChatGPT/Claude.
"""
import sys
import os
...
from ra_orchestrator.graph_gui import RAOrchestratorGUI
...
class ResearchWorker(QThread):
    """Worker thread for running research to avoid blocking UI."""
    ...
    def run(self):
        ...
        try:
            orchestrator = RAOrchestratorGUI(
                api_key=self.api_key,
                output_dir=self.output_dir
            )

            # Run research (non-interactive mode)
            final_state = orchestrator.run(self.research_question)
...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        self._add_assistant_message(
            ...
            "• Breaking down your question into focused sub-questions\n"
    ...
    def _send_message(self):
        ...
        self._add_assistant_message(
            ...
            "4. Extract and analyze evidence\n"
            "5. Generate synthesis and executive summary\n\n"
            "Please wait..."
        )
